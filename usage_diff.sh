...
join -1 1 -2 1 <(sort $dir1/ordered_usage_per_user.txt) <(sort $dir2/ordered_usage_per_user.txt) | awk '{print $0,$2-$3}' | awk '{if ($4!=0) {print $0}}' | sort -k4nr > $outdir/usage_difference.txt
